...
subroutine parameter(input_i3d)
  ...
  NAMELIST /ibmstuff/ cex,cey,cez,ra,rai,rao,nobjmax,nraf,nvol,iforces, npif, izap, ianal, imove, thickness, chord, omega ,ubcx,ubcy,ubcz,rads, c_air, wall_offset, surfacefile
  ...
  if (nrank==0) then
     ...
     if (iibm==2) then
       ...
       write(*,"(' wall-offset            : ',F17.2)") wall_offset
       write(*,"(' Input wall-surface     : ',A17)") surfacefile 
     end if
     write(*,*) '==========================================================='
